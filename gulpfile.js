...
gulp.task('lint', lvsfGulpTasks.lint(dirsToLint, testDirsToLint));

gulp.task('stylecheck', lvsfGulpTasks.checkstyle(dirsToLint.concat(testDirsToLint)));
